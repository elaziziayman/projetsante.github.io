...
<qgis version="3.30.0-'s-Hertogenbosch">
  <identifier>Geoportail.DBO.ProvincesWGS84</identifier>
  <parentidentifier></parentidentifier>
  <language>FR</language>
  <type>dataset</type>
  <title>Geoportail.DBO.ProvincesWGS84</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link mimeType="" name="Personal GeoDatabase Feature Class" format="" url="file://" description="" type="Local Area Network" size=""/>
  </links>
  <dates/>
  <fees></fees>
