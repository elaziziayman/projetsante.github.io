...
function init() {
    ...
    var Cas = L.tileLayer.wms('http://localhost:8080/geoserver/Projet_Sant%C3%A9/wms', {
        layers: 'Regions',
        format: 'image/png',
        transparent: true,
        styles: 'Projet_Santé:style_cas'
    }).addTo(map);


    var Gueris = L.tileLayer.wms('http://localhost:8080/geoserver/Projet_Sant%C3%A9/wms', {
        layers: 'Regions',
        format: 'image/png',
        transparent: true,
        styles: 'Projet_Santé:style_gueri'
    });

    var Deces = L.tileLayer.wms('http://localhost:8080/geoserver/Projet_Sant%C3%A9/wms', {
        layers: 'Regions',
        format: 'image/png',
        transparent: true,
        styles: 'Projet_Santé:style_deces'
    });
    ...
    const overlayMaps = {
        "Nombre de cas": Cas,
        "Nombre de guéris": Gueris,
        "Nombre de décés": Deces     
    };
    ...
    function generateLegend(layers) {
        ...
        layers.forEach(function(layer) {
          ...
          if (layer === Cas) {
            layerName = 'Nombre de cas';
            style = 'Projet_Santé:style_cas';
          } else if (layer === Gueris) {
            layerName = 'Nombre de guéris';
            style = 'Projet_Santé:style_gueri';
          } else if (layer === Deces) {
            layerName = 'Nombre de décés';
            style = 'Projet_Santé:style_deces';
          }
          ...
          // Append the layer name and legend image to the legend container
